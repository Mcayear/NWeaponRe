...
import { ExecutorCommandSender } from 'cn.nukkit.command.ExecutorCommandSender';// TODO
import { NPCCommandSender } from 'cn.nukkit.command.NPCCommandSender';// TODO
...
export class Command {
    ...
    setCallback(callback) {
        this._commandBuilder.setCallback((sender, result, log) => {
            ...
            if (sender.isPlayer()) {// TODO: 还需要更多类型的判断
            ...
            } else if (sender instanceof ExecutorCommandSender) {
                origin.type = OriginType.ExecuteContext;
            } else if (sender instanceof NPCCommandSender) {
                origin.type = OriginType.GameDirectorEntity;
            }
            let output = {
                success: (msg) => {
