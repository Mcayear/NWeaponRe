import { defineData, getProbabilisticResults, getRandomNum,
    PaperConfigType } from "../util/Tool.js";
...
export function ForgingFakeInvChange (event) {
    ...
    if (slot == 0) {
        let paperData: PaperConfigType = PaperConfig[newItem.getCustomName()];
        if (paperData) {
