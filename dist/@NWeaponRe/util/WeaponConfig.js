...
if (File.exists("./plugins/NWeapon/Config.yml")) {
    MainConfig = JSON.parse(Util.YAMLtoJSON(File.readFrom("./plugins/NWeapon/Config.yml")));
}
const ItemTypeList = {
    "武器": "Weapon",
    "护甲": "Armor",
...
if (MainConfig.version != version) {
    ...
    if (!MainConfig.Seiko) {
        MainConfig.Seiko = {
            ...
            chance: [1, .7, .7, .7, .5, .5, .5, .3, .3, .3, .1, .1, .1],
            failed: [[3, .5, .15, .5, .3], [12, .5, .15, .5, .3]],
...
// 集中的延时任务调度
export var TaskExecList = new Map();
